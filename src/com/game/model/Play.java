...
public class Play extends ElementObj {
    ...
    public void keyClick(Boolean bl, int key) {
        ...
        if(isReverseStatus()){
            ...
            switch (key){
                case 37:action = 39; break;
                case 38:action = 40; break;
                case 39:action = 37; break;
                case 40:action = 38; break;
                case 32:action = 32; break;
                default: action = key;
            }
        }
...
//        }
    ...
    public void setBoomStuckStatus(boolean boomStuckStatus) {
        if(superCard == 0) {
            this.boomStuckStatus = boomStuckStatus;
        }
        else superCard--;
    }
}
